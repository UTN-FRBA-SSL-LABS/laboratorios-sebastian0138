...
> R: para iniciar el valor , y que no tengamos basura en la memoria
...
> R: esa línea debería multiplicar precio * cantidad 
...
> R: Sí, las líneas 29 y 30 , la parte de carrito_descunto, no se ejecutan porque el make , compila y corre solo los test unitario, y esa funciones solo estan en el test de integracion
...
> R:uun test unitario prueba una funcion aislada mientras que uno de integracion, prueban un flujo. El bug lo detecto un test unitario
...
> R: Porque c no valida limites del array y puede borrar otra cosa que este en la memoria
...
> R:Que se sabe lo que se tiene que obtener y se prueba directamente, si yo se que los test estan bien hechos , el dia de mañana si se cambia algo, corro test y si nada rompen nada deberia de fallar por este cambio que hice
...
> R: porque dan bien con 1, el tema es si es mas de 1 la cantidad , multiplicar por 1 es lo mismo que sumar una vez
